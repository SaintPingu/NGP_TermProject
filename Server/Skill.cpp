...
void BossSkillManager::Skill1_Elec(Player* player)
{
	...
	{
		if (skillEffects.at(i).Animate(player) == false)
		{
...
void BossSkillManager::Skill2_Elec(Player* player)
{
	...
	{
		if (warningEffects.at(i).Animate(player) == false)
		{
...
void BossSkillManager::Skill1_Water(Player* player)
{
...
void BossSkillManager::Skill2_Water(Player* player)
{
	constexpr int lines = 16;
...
void BossSkillManager::Skill1_Fire(Player* player)
{
	...
	{
		if (skillEffects.at(i).Animate(player) == false || skillEffects.at(i).RotateToPlayer(0.225f, player) == false)
		{
...
void BossSkillManager::Skill2_Fire(Player* player)
{
	...
	{
		if (warningEffects.front().Animate(player) == false)
		{
	...
	{
		if (skillEffects.front().Animate(player) == false)
		{
			skillEffects.clear();
		}
	}
...
void BossSkillManager::Skill1_Dark(Player* player)
{
...
void BossSkillManager::Skill2_Dark(Player* player)
{
	if (warningEffects.empty() == false)
	{
		if (warningEffects.back().Animate(player) == false)
		{
			warningEffects.clear();
		}
		else
