...
{
	explode_fire.Load({ 56, 56 }, 8);
	explode_fire.ScaleImage(0.7f, 0.7f);
	explode_elec.Load({ 81, 73 }, 8);
	explode_elec.ScaleImage(0.6f, 0.6f);
	explode_water.Load({ 72, 64 }, 9);
	explode_water.ScaleImage(0.7f, 0.7f);
	explode_dark.Load({ 40, 40 }, 12);

	cloud_fire.Load({ 56, 64 }, 11);
	cloud_fire.ScaleImage(0.8f, 0.8f);
	cloud_elec.Load({ 56, 64 }, 11);
	cloud_elec.ScaleImage(0.8f, 0.8f);
	cloud_water.Load({ 48, 56 }, 15);
	cloud_water.ScaleImage(0.9f, 0.9f);
	cloud_dark.Load({ 56, 64 }, 11);
